...
# Platform fire editor - move add to bottom
path = Path(r"C:\workspace\insurance-prod-push\src\features\customers\components\CustomerFireInsuranceLocationsEditor.tsx")
