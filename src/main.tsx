...
import './features/customers/customer-detail-figma.css'
...
import './features/customers/customer-consultations-page.css'
import './features/customers/pages/detail/customer-detail-map-page.css'
