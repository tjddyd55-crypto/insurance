...
export function SmsAutomationRulePreviewPanel({
  ...
  return (
    <section className="sms-automation-rules__preview-panel" aria-label="대상자 미리보기">
      ...
      <p className="sms-automation-rules__preview-hint">
        미리보기는 실제 문자를 발송하지 않으며, 현재 설정된 규칙 기준으로 대상자와 발송 문구를 확인하는
        용도입니다.
      </p>
      ...
      {!canPreview ? (
        ...
        <div className="sms-automation-rules__preview-body">
          ...
          <p className="sms-automation-rules__preview-footnote">
            자동문자 실제 발송 결과는{' '}
            <Link className="sms-automation-rules__preview-footnote-link" to="/sms/history">
              발송내역
            </Link>
            에서 확인할 수 있습니다.
          </p>
