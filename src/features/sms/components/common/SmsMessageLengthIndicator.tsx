...
import type { SmsMessageLengthIndicatorProps } from './smsMessagePreview.types'
import SmsMessageTypeBadge from '../composer/SmsMessageTypeBadge'

export function SmsMessageLengthIndicator({
  meta,
  realSendEnabled = true,
  transitionNotice,
  onDismissTransition,
  className,
}: SmsMessageLengthIndicatorProps) {
  ...
  return (
    <div className={`sms-composer__meta-bar${className ? ` ${className}` : ''}`}>
...
export default SmsMessageLengthIndicator
