...
import { deleteCustomer, listCustomerForms, listCustomers, saveCustomer } from '../api/customersApi'
              ...
              <li key={c.id} className="record-card customer-expand-card">
                ...
                {expandedId === c.id ? (
                  <div className="customer-expand-detail">
                    ...
                    <div className="customer-expand-detail__actions">
                      <button className="button button--secondary" type="button" onClick={() => void copyCustomer(c)}>
                        카톡 복사
                      </button>
                      <button className="button button--primary" type="button" onClick={() => goToCarEdit(c)}>
                        자동차 정보 입력
                      </button>
                      <button
