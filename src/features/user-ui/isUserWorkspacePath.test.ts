...
describe('isUserWorkspacePath', () => {
  it('includes primary user workspace routes', () => {
    ...
    expect(isUserWorkspacePath('/portal/adjuster-news')).toBe(true)
    expect(isUserWorkspacePath('/portal/adjuster-news/recent')).toBe(true)
    expect(isUserWorkspacePath('/portal/boards/global-test')).toBe(true)
    expect(isUserWorkspacePath('/portal/boards/global-test/abc123')).toBe(true)
