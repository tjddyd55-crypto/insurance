  ...
  return (
    <div className="cs-mobile-dock cs-mobile-dock--totals-only" data-testid="coverage-simulator-mobile-sticky-dock">
      <div className="cs-mobile-dock__summary cs-mobile-dock__summary--compact" aria-live="polite">
        <div className="cs-mobile-dock__col cs-mobile-dock__col--inline">
          <span className="cs-mobile-dock__label">기존</span>
        ...
        <div className="cs-mobile-dock__col cs-mobile-dock__col--inline cs-mobile-dock__col--proposed">
          <span className="cs-mobile-dock__label">제안</span>
