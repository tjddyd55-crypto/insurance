    ...
    <LegalPageShell title="개인정보처리방침" pageId="privacy-policy-top">
      ...
      <article className="legal-doc">
        ...
        <section className="legal-doc__section" id="s2">
          ...
          <ul className="legal-doc__list">
            <li>
              <strong>처리 목적</strong>: 소개 페이지를 통해 접수된 도입·이용 문의에 대한 확인, 답변 및 안내
            </li>
            <li>
              <strong>수집 항목</strong>: 필수 — 이름, 연락처, 문의 유형, 문의 내용, 개인정보 수집·이용 동의.
              선택 — 소속(GA·지점), 이메일, 연락 가능 시간
            </li>
            <li>
              <strong>보유 및 이용 기간</strong>: 제3조와 동일하게, 법령상 보관 의무가 있는 경우를 제외하고
              수집·이용 목적 달성 시 지체 없이 파기합니다.
            </li>
            <li>
              <strong>동의 거부권</strong>: 동의를 거부할 수 있으나, 이 경우 온라인 문의 접수가 제한됩니다.
            </li>
          </ul>
          <p>
