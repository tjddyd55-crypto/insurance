...
export function EvidenceStatusPanel({ detail, loading, onRefresh }: Props) {
  return (
    <div>
      ...
      {!detail ? (
        <p style={{ fontSize: 13, color: 'var(--text-secondary)' }}>발송 세션을 만든 뒤 새로고침하면 문서·evidence 가 표시됩니다.</p>
      ) : (
        <div style={{ fontSize: 13 }}>
          <h6 className="mt-3">세션</h6>
          <ul>
          ...
          <h6 className="mt-3">문서 / evidence</h6>
      ...
      <h6 className="mt-4">테스트 절차 안내</h6>
