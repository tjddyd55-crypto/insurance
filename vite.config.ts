...
export default defineConfig({
  ...
  test: {
    ...
    exclude: [
      ...
      'src/features/customers/components/CustomerEditForm.import.test.ts',
      'src/features/sms/config/smsAutomationRule.config.test.ts',
      'src/features/sms/utils/smsAutomationPreviewMessage.test.ts',
      'src/features/storage/components/storageExplorerLayout.contract.test.ts',
      'src/lib/kakaoPostcode/loadKakaoPostcode.test.ts',
